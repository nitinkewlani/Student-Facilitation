...
<div class="w3-deep-orange w3-bar w3-card-4 navb">
            ...
            <a href="homeaftersignup2.php" class="w3-large w3-bar-item w3-button w3-hover-teal w3-hover-text-orange">About</a> 
            <a href="homeaftersignup2.php" class="w3-large w3-bar-item w3-button w3-hover-teal w3-hover-text-orange ">Contact</a> 
            <a href="complain2.php" class="w3-large w3-bar-item w3-button w3-hover-teal w3-hover-text-orange " >ComplainBox</a>
     <a href="profile2.php" class="w3-large w3-bar-item w3-btn w3-hover-text-orange w3-hover-text-orange w3-teal ">Profile</a>
  ...
  <div class="row">
    ...
    <div class="column">
      <form action="updt.php" method="post">
        ...
        <input class="tt" type="text" id="sem" name="sem" placeholder="Enter your sem..">
        
        <label for="fname">Department</label>
        <input class="tt" type="text" id="dept" name="dept" placeholder="Enter your department..">
    
        <label for="fname">Section</label>
        <input class="tt" type="text" id="sec" name="sec"  placeholder="Enter your section..">
        
        <label for="fname">Room No.</label>
        <input class="tt" type="text" id="roomno" name="roomno"  placeholder="Enter your room no.">
        
        <label for="fname">Phone</label>
        <input class="tt" type="number" id="pno"  name="pno" value="<?php echo $arr['phone']; ?>" placeholder="Enter your phone number.." >
        
        <label for="fname">Parent Phone</label>
        <input class="tt" type="number"  id="pphone" name="pphone" placeholder="Enter your Parent Phone Number..">
        
        <label for="fname">Parent Address</label>
        <input class="tt" type="text" id="paddr" name="paddr" placeholder="Enter Parent's address ..">
        
        <label for="fname">Local Guardian Name</label>
        <input class="tt" type="text" id="lgname" name="lgname" placeholder="Enter your Local Guardian Name..">
        
        <label for="fname">Local Guardian Phone</label>
        <input class="tt" type="number" id="lgphone" name="lgphone" placeholder="Enter your Local Guardian Name..">
          
        <label for="fname">Local Guardian Address</label>
        <input class="tt" type="text" id="lgaddr" name="lgaddr" placeholder="Enter your Local Guardian Address..">
